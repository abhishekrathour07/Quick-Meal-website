...
const MenuItems: React.FC<FoodItem> = ({ name, image, price, description,onRemove }) => {
    ...
    return (
        <div className="flex flex-col justify-between p-2 lg:p-4 m-2 bg-slate-100 rounded-lg py-6 drop-shadow-lg ">
            <div className="flex justify-center mb-4">
                <img src={image} alt={name} className="rounded-full h-48 w-48" />
            </div>
            <h3 className="text-lg text-center text-green-600">{name}</h3>
