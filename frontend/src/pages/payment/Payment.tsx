    ...
    return (
        <div className="p-6 bg-gray-100 flex flex-col md:flex-row justify-around px-4 md:px-12 gap-6 h-screen">
            <div className="w-full lg:w-60% bg-white p-8 mt-4 shadow-lg rounded-lg h-fit">
                    ...
                    <div>
                        <div className="flex items-center border h-16 rounded-lg px-4">
                            <input
                                ...
                                className="mr-2"
                            />
                            <label htmlFor="netbanking" className="cursor-pointer">Net Banking or UPI</label>
                        </div>
                    ...
                    <div>
                        <div className="flex items-center border h-16 rounded-lg px-4">
                            <input
                                ...
                                className="mr-2"
                            />
                            <label htmlFor="emi" className="cursor-pointer">Pay Through EMI</label>
                        </div>
                ...
                <button className='bg-slate-900 text-white font-semibold text-lg px-4 py-2 w-full mt-4 rounded-lg'>Confirm Order</button>
            </div>
